...
namespace inmuebles
{
    //INTEGRANTES DEL EQUIPO: FRANKLIN NOE SOLORZANO ERAZO & LUIS ELIAN ARTEAGA DIAZ
    ...
    class program1
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Por favor ingrese su numero de DUI: ");
            persona.dui = Console.ReadLine();
